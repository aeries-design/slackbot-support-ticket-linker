...
main
  ...
  .flex.w-full
    .flex(class="w-96")
      .flex-col.w-full
        sidebar-projects
    .flex-col(v-if="currentSession" class="w-full bg-neutral-300 content_container ")
				...
				.then(function (response) {
					...
					axios
						...
						.then(function (response) {
							...
							//OKR sessions
							axios
								.get('/rest/okrs?_id=' + globalScope.$attrs.params.id)
								.then(function (response) {
