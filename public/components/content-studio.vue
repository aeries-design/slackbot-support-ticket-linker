...
<template lang='pug'>
  div#contentStudio(v-if="this.isDev")
    div.fixed.feedbackFab(v-show="!contentStudioModalIsActive" @click="contentStudioModalIsActive = true; startElementSelector();" title="Feedback")
