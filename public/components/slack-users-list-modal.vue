...
<template lang="pug">
.mx-auto.grid.grid-cols-1.row-gap-16
  .container
    div.px-8
      //- div
      //-   #clubs.container
      ...
      p(class="text-minimum-text mt-2 pb-4" v-if="slackTagList.length") {{numberOfSelectedUsers}} selected
      p(class="text-minimum-text mt-2 pb-4" v-else) 0 selected
    ...
    .mt-6.grid.grid-cols-1.row-gap-8(style="max-height: 600px; overflow-y: scroll; padding: 20px;")
