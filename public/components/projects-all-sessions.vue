  ...
  return output;
    ...
    sessionsAsGanttObjects() {
      ...
      for (var i = 0; i < this.okrs.sessions.length; i++) {
        ...
        output.tasks.push({
          text: sesh.title,
          start_date: parseInt(sesh.start),
          end_date: parseInt(sesh.end),
          color: sesh.color,
          id: sesh._id,
...
//OKR sessions
      axios
      .get('/rest/okrs?type=session&$limit=9999&deleted[$ne]=true&$sort[start]=1')
                  ...
                  axios
                    ...
                    axios
                      ...
                      .then(function (response) {
                        ...
                        globalScope.refreshOKRSessions();
