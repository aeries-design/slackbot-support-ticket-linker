...
class TreeChart {
    ...
    render() {
        ...
        */
        ...
        attrs.centerG = chart.patternify({
            ...
            .attr('transform', () => {
                if (attrs.layout === 'h') return `translate(${calc.nodeMaxWidth},${calc.centerY}) scale(${attrs.initialZoom})`;
    ...
    collapseAll() {
        const attrs = this.getChartState();
        attrs.data.forEach(function(node) {
            node.expanded = false;
        })
        this.updateNodesState();    
    }
    ...
    update({
        ...
        nodeUpdate.selectAll('.node-image-group')
            .attr('transform', ({
                ...
                let x = -imageWidth / 2 - width / 3
                let y = -imageHeight / 5 - height / 5;
        ...
        nodeUpdate.select('.node-button-g')
            .attr('transform', ({
                ...
                if (attrs.layout == 'h') return `translate(${data.width / 1.8},0)`
                return `translate(0,${data.height / 1.3})`
            })
            .attr('opacity', ({
                children,
                _children
        ...
        nodeUpdate.select('.node-button-circle')
            ...
            .attr('stroke-width', ({
                ...
                if (children) return data.borderWidth || attrs.strokeWidth
                return 0;
            })
            ...
            .attr('fill', ({
                ...
                if (children) return attrs.backgroundColor
                return '#505F79';  
            })
        ...
        nodeUpdate.select('.node-button-text')
            ...
            .attr('fill', ({
                ...
                if (children) return attrs.defaultTextFill
                return '#FFF';
            ...
            .text(({
                ...
                if (children) return '-';
                return data.totalSubordinates;
            })
            .attr('y', this.isEdge() ? 10 : 2)
